...
setTimeout(()=>{
  ...
  sec('Breadcrumb: Timeline › name, and the way back');
  ok('the trail renders',E("document.getElementById('md-home').textContent")==='Timeline'&&
     E("document.querySelector('#me-dock .md-hd .t').textContent")==='Nick');
  E("document.getElementById('md-home').click();");
  ...
  E("document.getElementById('md-close').click();");
