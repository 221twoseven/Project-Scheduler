# To-Do / Backlog — v1.x track (ARCHIVE)

> **Retired 2026-09-24.** This is the v1.x backlog (v1.0.2 → v1.23.0, 2026-08-28 → 2026-09-24),
> kept as history and rationale. **The working backlog is [`docs/TODO.md`](../TODO.md)**
> (Phase 7). Every entry still open here at retirement was checked against the code on
> 2026-09-24 and carried into the new file's §7 ledger with its gate; twelve entries were
> found already shipped or stale and are closed there, not here. The text below is frozen as
> of retirement — tick marks and "Last reviewed" were not updated.


**The single working to-do list for Project Scheduler (Timeline).** Started 2026-08-28,
when the v1 backlog was retired to
[`docs/Archive/TODO-v1-Archive.md`](TODO-v1-Archive.md) with everything closed
...
`docs/Milestones/Phase-5-V1-Close-out/2026-08-28-semver-switch.md`). Bump the **patch** for fixes, copy, and
...
`docs/Milestones/Phase-6-v1.x-Release-Train/2026-09-02-v1181-audit-fixes.md`). The one owner action from it is
...
Record: `docs/Milestones/Phase-6-v1.x-Release-Train/2026-08-31-v161-preview-polish.md`. The second review round
...
`docs/Milestones/Phase-6-v1.x-Release-Train/2026-08-31-v162-preview-polish-2.md`. The third round (2026-09-01:
...
`docs/Milestones/Phase-6-v1.x-Release-Train/2026-09-01-v164-preview-polish-3.md`. Same day, the owner's live-data
...
`docs/Milestones/Phase-6-v1.x-Release-Train/2026-09-01-v165-legacy-person-ids.md`. The owner's follow-up on the
...
reset. Record: `docs/Milestones/Phase-6-v1.x-Release-Train/2026-09-01-v166-filter-dropdown.md`.

---

## 1. Where v1 came from (REV50 → v1.0.1, condensed)

The full story lives in the archive, `docs/Milestones/`, and `reference/Handoff-Notes.md`
...
- [x] **Stale "Settings" strings in the app — DONE 2026-08-28 (v1.0.2):** all five
      ...
      (`docs/Milestones/Phase-6-v1.x-Release-Train/2026-08-28-v102-quick-wins.md`).
...
- [x] **10. Calendar detail levels — DONE 2026-09-09 (v1.21.0, development /
      ...
      Milestone: `docs/Milestones/Phase-6-v1.x-Release-Train/2026-09-09-calendar-detail-levels.md`.
...
- [x] **10. (Obj 1) My Dashboard becomes its own place — DONE 2026-08-31 (v1.2.0).**
      ...
      `docs/Milestones/Phase-6-v1.x-Release-Train/2026-08-31-v120-dashboard-view.md`. Suite:
...
- [x] **12. (Obj 3) Admin vs regular user permissions — DONE 2026-09-01 (v1.8.0).**
      ...
      `docs/Milestones/Phase-6-v1.x-Release-Train/2026-09-01-v180-permissions.md`. Suite: `tests/test-v180.js`.
...
- [x] **27. (09-01 handoff) People and Clients become first-class application pages —
      ...
      `docs/Milestones/Phase-6-v1.x-Release-Train/2026-09-01-v170-company-data.md`. Ceilings ledgered in §7
      ...
      **modal → batch form → save/cancel** becomes **persistent location → record
      ...
      `docs/Archive/Master-Data-UX-Refactor-Handoff.md`** (staff names in its
...
- [x] **28. (09-01 items 6–9) Four quick wins — DONE 2026-09-01 (v1.7.2):**
      ...
      `docs/Milestones/Phase-6-v1.x-Release-Train/2026-09-01-v172-quick-wins-and-scrub.md`. Suite:
      `tests/test-v172.js`.
...
- [x] **31. (09-01 sidebar feedback) ⇕ All levels + header parity — DONE 2026-09-01
      ...
      colored pill. Record:
      `docs/Milestones/Phase-6-v1.x-Release-Train/2026-09-01-v181-sidebar-headers-and-all-toggle.md`. Suite:
...
- [x] **32. (09-01 late-evening handoff) Four owner asks — DONE 2026-09-01 (v1.9.0).**
      ...
      `docs/Milestones/Phase-6-v1.x-Release-Train/2026-09-01-v190-owner-asks.md`.
...
- [x] **42. (09-02 night, owner report) Orphaned "TBD" lane in the dept lens — DONE
      ...
      Record: `docs/Milestones/Phase-6-v1.x-Release-Train/2026-09-02-v1183-child-first-deletes.md`. Suite:
      `tests/test-v1183.js`.
...
- [x] **43. (09-15, owner ask) Weekly schedule on the People page — DONE 2026-09-15
      ...
      Record: `docs/Milestones/Phase-6-v1.x-Release-Train/2026-09-15-people-schedule.md`. Suite:
      `tests/test-v1220.js`.
...
- **Standing rule:** re-verify `reference/Handoff-Notes.md` world-state claims before
  quoting them — it's history + rationale; `ARCHITECTURE.md`/`SETUP.md` are current.
- 2026-09-24: docs decluttered. Milestones regrouped into numbered phase folders
  (`Phase-0-Foundations` … `Phase-6-v1.x-Release-Train`, records flat and date-prefixed).
  Handoff-Notes and Project-History(+TLDR) moved to `reference/`. The Master Data brief
  (shipped v1.7.0) and Onboarding-Fork moved to `docs/Archive/`. All links repointed.
