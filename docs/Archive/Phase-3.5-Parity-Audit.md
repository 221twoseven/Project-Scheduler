...
landed 2026-08-26 as **REV81** (`docs/Milestones/Phase-3.5-Parity-Audit/2026-08-26-parity-quick-wins.md`).
**The inspector convergence (D1–D4, L1/L3/L4, I1–I7, I9–I12) shipped the same day as
REV82** (`docs/Milestones/Phase-3.5-Parity-Audit/2026-08-26-inspector-convergence.md`) — draft selection is
