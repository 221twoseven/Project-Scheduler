...
- **Run the tests after implementation changes.** `tests/run.js` aggregates all 18 suites
  (behaviour suites `test46`–`test55`, `test-label`, plus the Phase 1–2 UX/design suites);
